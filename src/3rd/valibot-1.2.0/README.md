...
at runtime to guarantee the type safety of unknown data.
...
Thanks to our partners who support my development!
[Join them](https://github.com/sponsors/fabian-hiller) and contribute to the
...
[bachelor thesis](https://valibot.dev/thesis.pdf) at
...
[issue](https://github.com/open-circle/valibot/issues/new). Together we can make
the library even better!

## License

I am completely free and licensed under the
[MIT license](https://github.com/open-circle/valibot/blob/main/LICENSE.md). But
if you like, you can feed me with a star on
