...
function setSpecificMessage(reference, message$1, lang) {
  ...
  if (!store$1.get(reference)) {
    store$1.set(reference, /* @__PURE__ */ new Map());
  }
...
function _addIssue(context, label, dataset, config$1, other) {
  ...
  const message$1 = other?.message ?? context.message ?? /* @__PURE__ */
    getSpecificMessage(context.reference, issue.lang) ??
    (isSchema ? /* @__PURE__ */ getSchemaMessage(issue.lang) : null) ??
    config$1.message ?? /* @__PURE__ */ getGlobalMessage(issue.lang);
  if (message$1 !== void 0) {
    issue.message = typeof message$1 === "function"
      ? message$1(issue)
      : message$1;
  }
...
function _isValidObjectKey(object$1, key) {
  return Object.hasOwn(object$1, key) && key !== "__proto__" &&
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed) {
        ...
        if (length$1 !== this.requirement) {
          _addIssue(this, "bytes", dataset, config$1, {
            received: `${length$1}`,
          });
        }
      }
  ...
  return {
    ...
    requirement(input) {
      ...
      return CREDIT_CARD_REGEX.test(input) &&
        ...
        PROVIDER_REGEX_LIST.some((regex$1) =>
          regex$1.test(sanitized)
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !dataset.value.endsWith(this.requirement)) {
        _addIssue(this, "end", dataset, config$1, {
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      ...
      if (dataset.typed && count !== this.requirement) {
        _addIssue(this, "entries", dataset, config$1, { received: `${count}` });
      }
      return dataset;
    },
  };
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && dataset.value.includes(this.requirement)) {
        _addIssue(this, "content", dataset, config$1, { received });
      }
      return dataset;
    },
  };
...
function finite(message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement(dataset.value)) {
        _addIssue(this, "finite", dataset, config$1);
      }
      return dataset;
    },
  };
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed) {
        ...
        if (count !== this.requirement) {
          _addIssue(this, "graphemes", dataset, config$1, {
            received: `${count}`,
          });
        }
      }
  ...
  return {
    ...
    expects: `>${
      requirement instanceof Date
        ? requirement.toJSON()
        : /* @__PURE__ */ _stringify(requirement)
    }`,
    requirement,
    message: message$1,
    "~run"(dataset, config$1) {
      if (dataset.typed && !(dataset.value > this.requirement)) {
        _addIssue(this, "value", dataset, config$1, {
          received: dataset.value instanceof Date
...
function hash(types, message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement.test(dataset.value)) {
        _addIssue(this, "hash", dataset, config$1);
      }
      return dataset;
    },
  };
...
function hexadecimal(message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement.test(dataset.value)) {
        _addIssue(this, "hexadecimal", dataset, config$1);
      }
      return dataset;
    },
  };
...
function hexColor(message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement.test(dataset.value)) {
        _addIssue(this, "hex color", dataset, config$1);
      }
      return dataset;
    },
  };
...
function imei(message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement(dataset.value)) {
        _addIssue(this, "IMEI", dataset, config$1);
      }
      return dataset;
    },
  };
...
function includes(requirement, message$1) {
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !dataset.value.includes(this.requirement)) {
        _addIssue(this, "content", dataset, config$1, {
          received: `!${expects}`,
        });
      }
      return dataset;
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && dataset.value.size > this.requirement) {
        _addIssue(this, "size", dataset, config$1, {
...
function maxWords(locales, requirement, message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed) {
        const count = /* @__PURE__ */ _getWordCount(
          this.locales,
          dataset.value,
        );
        if (count > this.requirement) {
          _addIssue(this, "words", dataset, config$1, { received: `${count}` });
        }
      }
      return dataset;
    },
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement.includes(dataset.value.type)) {
        _addIssue(this, "MIME type", dataset, config$1, {
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && dataset.value % this.requirement != 0) {
        _addIssue(this, "multiple", dataset, config$1);
      }
      return dataset;
    },
  };
...
function notValues(requirement, message$1) {
  return {
    ...
    async: false,
    expects: `!${
      /* @__PURE__ */ _joinExpects(
        requirement.map((value$1) =>
          value$1 instanceof Date
            ? value$1.toJSON()
            : /* @__PURE__ */ _stringify(value$1)
        ),
        "|",
      )
    }`,
    ...
    "~run"(dataset, config$1) {
      if (
        dataset.typed &&
        this.requirement.some((value$1) =>
          value$1 <= dataset.value && value$1 >= dataset.value
        )
      ) {
        _addIssue(this, "value", dataset, config$1, {
          received: dataset.value instanceof Date
...
function partialCheck(paths, requirement, message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (
        (dataset.typed || /* @__PURE__ */ _isPartiallyTyped(dataset, paths)) &&
        !this.requirement(dataset.value)
      ) _addIssue(this, "input", dataset, config$1);
      return dataset;
    },
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      action({
        ...
        config: config$1,
        addIssue: (info) =>
          _addIssue(this, info?.label ?? "input", dataset, config$1, info),
      });
      return dataset;
    },
  };
...
function safeInteger(message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement(dataset.value)) {
        _addIssue(this, "safe integer", dataset, config$1);
      }
      return dataset;
    },
  };
...
function slug(message$1) {
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !this.requirement.test(dataset.value)) {
        _addIssue(this, "slug", dataset, config$1);
      }
      return dataset;
    },
  };
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.typed && !dataset.value.startsWith(this.requirement)) {
        _addIssue(this, "start", dataset, config$1, {
...
function toMaxValue(requirement) {
  return {
    ...
    requirement,
    "~run"(dataset) {
      dataset.value = dataset.value > this.requirement
        ? this.requirement
        : dataset.value;
      return dataset;
    },
  ...
  return {
    ...
    async "~run"(dataset, config$1) {
      ...
      return outputDataset.issues
        ? {
          typed: true,
          value: await /* @__PURE__ */ getFallback(
            this,
            outputDataset,
            config$1,
          ),
...
function getDefaults(schema) {
  if ("entries" in schema) {
    ...
    for (const key in schema.entries) {
      object$1[key] = /* @__PURE__ */ getDefaults(schema.entries[key]);
    }
    return object$1;
  }
...
async function getDefaultsAsync(schema) {
  if ("entries" in schema) {
    return Object.fromEntries(
      await Promise.all(
        Object.entries(schema.entries).map(async (
          [key, value$1],
        ) => [key, await /* @__PURE__ */ getDefaultsAsync(value$1)]),
      ),
    );
  }
...
function getExamples(schema) {
  ...
  function depthFirstCollect(schema$1) {
    if ("pipe" in schema$1) {
      for (const item of schema$1.pipe) {
        if (item.kind === "schema" && "pipe" in item) depthFirstCollect(item);
        else if (item.kind === "metadata" && item.type === "examples") {
          examples$1.push(...item.examples);
        }
      }
    }
  }
...
function getFallbacks(schema) {
  if ("entries" in schema) {
    const object$1 = {};
    for (const key in schema.entries) {
      object$1[key] = /* @__PURE__ */ getFallbacks(schema.entries[key]);
    }
    return object$1;
  }
  ...
  if ("entries" in schema) {
    return Object.fromEntries(
      await Promise.all(
        Object.entries(schema.entries).map(async (
          [key, value$1],
        ) => [key, await /* @__PURE__ */ getFallbacksAsync(value$1)]),
      ),
    );
  }
  if ("items" in schema) {
...
function getMetadata(schema) {
  ...
  function depthFirstMerge(schema$1) {
    if ("pipe" in schema$1) {
      for (const item of schema$1.pipe) {
        if (item.kind === "schema" && "pipe" in item) depthFirstMerge(item);
    ...
    async "~run"(dataset, config$1) {
      ...
      if (Array.isArray(input)) {
        ...
        const itemDatasets = await Promise.all(
          input.map((value$1) =>
            this.item["~run"]({ value: value$1 }, config$1)
          ),
        );
...
function enum_(enum__, message$1) {
  ...
  for (const key in enum__) {
    if (
      `${+key}` !== key || typeof enum__[key] !== "string" ||
...
function _merge(value1, value2) {
  if (typeof value1 === typeof value2) {
    ...
    if (
      value1 && value2 && value1.constructor === Object &&
      ...
      if (this.options.length) {
        ...
        if (dataset.typed) {
          ...
          for (let index = 1; index < outputs.length; index++) {
            const mergeDataset = /* @__PURE__ */ _merge(
              dataset.value,
              outputs[index],
            );
      ...
      if (this.options.length) {
        ...
        const optionDatasets = await Promise.all(
          this.options.map((schema) =>
            schema["~run"]({ value: input }, config$1)
          ),
        );
      ...
      if (input && typeof input === "object") {
        ...
        if (!dataset.issues || !config$1.abortEarly) {
          for (const key in input) {
            if (
              /* @__PURE__ */ _isValidObjectKey(input, key) &&
                !(key in this.entries)
  ...
  return {
    ...
    async "~run"(dataset, config$1) {
      ...
      if (input && typeof input === "object") {
        ...
        for (const [key, value$1, valueSchema, valueDataset] of valueDatasets) {
          if (valueDataset) {
            if (valueDataset.issues) {
              const pathItem = {
                type: "object",
  ...
  return {
    ...
    async "~run"(dataset, config$1) {
      ...
      if (input instanceof Map) {
        ...
        for (
          const [inputKey, inputValue, keyDataset, valueDataset] of datasets
        ) {
          if (keyDataset.issues) {
            const pathItem = {
              type: "map",
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      if (dataset.value !== null) {
        dataset = this.wrapped["~run"](dataset, config$1);
      }
...
function nonNullableAsync(wrapped, message$1) {
  return {
    ...
    async "~run"(dataset, config$1) {
      if (dataset.value !== null) {
        dataset = await this.wrapped["~run"](dataset, config$1);
      }
      if (dataset.value === null) _addIssue(this, "type", dataset, config$1);
      return dataset;
    },
...
function nullableAsync(wrapped, default_) {
  return {
    ...
    async "~run"(dataset, config$1) {
      if (dataset.value === null) {
        if (this.default !== void 0) {
          dataset.value = await /* @__PURE__ */ getDefault(
            this,
            dataset,
            config$1,
          );
  ...
  return {
    ...
    async "~run"(dataset, config$1) {
      ...
      if (input && typeof input === "object") {
        ...
        for (
          const [key, value$1, valueSchema, valueDataset] of normalDatasets
        ) {
          if (valueDataset) {
            if (valueDataset.issues) {
              const pathItem = {
        ...
        if (!dataset.issues || !config$1.abortEarly) {
          for (const [key, value$1, valueDataset] of restDatasets) {
            if (valueDataset.issues) {
              const pathItem = {
                type: "object",
                origin: "value",
  ...
  return {
    ...
    async "~run"(dataset, config$1) {
      ...
      if (input && typeof input === "object") {
        ...
        dataset.value = {};
        const datasets = await Promise.all(
          Object.entries(input).filter(([key$1]) =>
            /* @__PURE__ */ _isValidObjectKey(input, key$1)
        ...
        for (
          const [entryKey, entryValue, keyDataset, valueDataset] of datasets
        ) {
          if (keyDataset.issues) {
            const pathItem = {
              type: "object",
      ...
      if (input instanceof Set) {
        ...
        const valueDatasets = await Promise.all(
          [...input].map(async (
            ...
            inputValue,
            await this.value["~run"]({ value: inputValue }, config$1),
          ]),
        );
  ...
  return {
    ...
    "~run"(dataset, config$1) {
      ...
      if (Array.isArray(input)) {
        ...
        if (
          !(dataset.issues && config$1.abortEarly) &&
    ...
    async "~run"(dataset, config$1) {
      ...
      if (Array.isArray(input)) {
        ...
        const [normalDatasets, restDatasets] = await Promise.all([
          ...
          Promise.all(
            input.slice(this.items.length).map(async (value$1, key) => {
              return [
                key + this.items.length,
                value$1,
                await this.rest["~run"]({ value: value$1 }, config$1),
        ...
        if (!dataset.issues || !config$1.abortEarly) {
          for (const [key, value$1, itemDataset] of restDatasets) {
            if (itemDataset.issues) {
              const pathItem = {
                type: "array",
                origin: "value",
          ...
          for (const schema of variant$1.options) {
            if (schema.type === "variant") {
              ...
              if (keysAreValid) {
                ...
                if (
                  !outputDataset || !outputDataset.typed && optionDataset.typed
...
function partial(schema, keys) {
  const entries$1 = {};
  for (const key in schema.entries) {
    entries$1[key] = !keys || keys.includes(key)
...
function partialAsync(schema, keys) {
  ...
  for (const key in schema.entries) {
    entries$1[key] = !keys || keys.includes(key)
      ? /* @__PURE__ */ optionalAsync(schema.entries[key])
      : schema.entries[key];
  }
  return {
    ...schema,
    ...
    "~run"(dataset, config$1) {
      for (const item of pipe$1) {
        if (item.kind !== "metadata") {
          ...
          if (
            !dataset.issues || !config$1.abortEarly && !config$1.abortPipeEarly
...
function required(schema, arg2, arg3) {
  ...
  for (const key in schema.entries) {
    entries$1[key] = !keys || keys.includes(key)
      ? /* @__PURE__ */ nonOptional(schema.entries[key], message$1)
      : schema.entries[key];
  }
  return {
    ...schema,
...
function requiredAsync(schema, arg2, arg3) {
  ...
  for (const key in schema.entries) {
    entries$1[key] = !keys || keys.includes(key)
      ? /* @__PURE__ */ nonOptionalAsync(schema.entries[key], message$1)
      : schema.entries[key];
  }
  return {
    ...schema,
...
function safeParserAsync(schema, config$1) {
  const func = (input) =>
    /* @__PURE__ */ safeParseAsync(schema, input, config$1);
  func.schema = schema;
  func.config = config$1;
  return func;
}
